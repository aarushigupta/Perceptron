...
def split_into_words(data):
	try:
		...
		# words_in_reviews = [word for word in words_in_reviews if len(word.strip()) > 0]
	except:
...
if __name__ == '__main__':
	...
	weights_true_fake, weights_pos_neg, bias_TF, bias_PN = train_vanilla_perceptron(10, label_true_fake, label_pos_neg, unique_words, one_hot_vector)
